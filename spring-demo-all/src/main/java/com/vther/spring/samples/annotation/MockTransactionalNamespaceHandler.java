 ...
 * @since 2.0
 */
public class MockTransactionalNamespaceHandler extends NamespaceHandlerSupport {
	...
	@Override
	public void init() {
		registerBeanDefinitionParser("annotation-driven", new MockAnnotationDrivenBeanDefinitionParser());
	}
